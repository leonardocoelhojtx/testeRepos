...
function NgxSelectComponent_div_3_span_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("innerHtml", ctx_r106.placeholder, ɵngcc0.ɵɵsanitizeHtml);
} }
...
function NgxSelectComponent_div_3_span_3_Template(rf, ctx) { if (rf & 1) {
    ...
    const _r102 = ɵngcc0.ɵɵreference(8);
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(3, _c3, ctx_r107.allowClear));
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r107.templateSelectedOption || _r102)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(5, _c4, ctx_r107.optionsSelected[0], ctx_r107.sanitize(ctx_r107.optionsSelected[0].text)));
} }
function NgxSelectComponent_div_3_a_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function NgxSelectComponent_div_3_a_5_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r110); const ctx_r109 = ɵngcc0.ɵɵnextContext(2); return ctx_r109.optionRemove(ctx_r109.optionsSelected[0], $event); });
    ɵngcc0.ɵɵelement(1, "i", 22);
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r108 = ɵngcc0.ɵɵnextContext(2);
    ɵngcc0.ɵɵproperty("ngClass", ctx_r108.setBtnSize());
} }
function NgxSelectComponent_div_3_Template(rf, ctx) { if (rf & 1) {
    const _r112 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "div", 9);
    ɵngcc0.ɵɵelementStart(1, "div", 10);
    ɵngcc0.ɵɵlistener("click", function NgxSelectComponent_div_3_Template_div_click_1_listener() { ɵngcc0.ɵɵrestoreView(_r112); const ctx_r111 = ɵngcc0.ɵɵnextContext(); return ctx_r111.optionsOpen(); });
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngClass", ctx_r98.setFormControlSize(ctx_r98.setBtnSize()));
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !ctx_r98.optionsSelected.length);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r98.optionsSelected.length);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r98.canClearNotMultiple());
} }
...
function NgxSelectComponent_div_4_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function NgxSelectComponent_div_4_span_1_Template_span_click_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r117); return $event.stopPropagation(); });
    ɵngcc0.ɵɵelementContainer(2, 20);
    ɵngcc0.ɵɵelementStart(3, "a", 26);
    ɵngcc0.ɵɵlistener("click", function NgxSelectComponent_div_4_span_1_Template_a_click_3_listener($event) { ɵngcc0.ɵɵrestoreView(_r117); const option_r114 = ctx.$implicit; const ctx_r118 = ɵngcc0.ɵɵnextContext(2); return ctx_r118.optionRemove(option_r114, $event); });
    ...
    const idx_r115 = ctx.index;
    const ctx_r113 = ɵngcc0.ɵɵnextContext(2);
    const _r102 = ɵngcc0.ɵɵreference(8);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngClass", ctx_r113.setBtnSize());
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r113.templateSelectedOption || _r102)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction3(4, _c5, option_r114, idx_r115, ctx_r113.sanitize(option_r114.text)));
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngClass", ctx_r113.setBtnSize());
} }
function NgxSelectComponent_div_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function NgxSelectComponent_div_4_Template_div_click_0_listener() { ɵngcc0.ɵɵrestoreView(_r120); const ctx_r119 = ɵngcc0.ɵɵnextContext(); return ctx_r119.inputClick(ctx_r119.inputElRef && ctx_r119.inputElRef["value"]); });
    ɵngcc0.ɵɵtemplate(1, NgxSelectComponent_div_4_span_1_Template, 5, 8, "span", 24);
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r99 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngForOf", ctx_r99.optionsSelected)("ngForTrackBy", ctx_r99.trackByOption);
} }
function NgxSelectComponent_input_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("keyup", function NgxSelectComponent_input_5_Template_input_keyup_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r123); const _r121 = ɵngcc0.ɵɵreference(1); const ctx_r122 = ɵngcc0.ɵɵnextContext(); return ctx_r122.inputKeyUp(_r121.value, $event); })("click", function NgxSelectComponent_input_5_Template_input_click_0_listener() { ɵngcc0.ɵɵrestoreView(_r123); const _r121 = ɵngcc0.ɵɵreference(1); const ctx_r124 = ɵngcc0.ɵɵnextContext(); return ctx_r124.inputClick(_r121.value); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r100 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngClass", ctx_r100.setFormControlSize())("tabindex", ctx_r100.multiple === false ? 0 - 1 : 0)("disabled", ctx_r100.disabled)("placeholder", ctx_r100.optionsSelected.length ? "" : ctx_r100.placeholder)("autocomplete", ctx_r100.autocomplete);
} }
...
function NgxSelectComponent_ul_6_li_2_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    const opt_r128 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(opt_r128.label);
} }
...
function NgxSelectComponent_ul_6_li_2_a_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("mouseenter", function NgxSelectComponent_ul_6_li_2_a_3_Template_a_mouseenter_0_listener() { ɵngcc0.ɵɵrestoreView(_r138); const option_r134 = ctx.$implicit; const ctx_r137 = ɵngcc0.ɵɵnextContext(3); return ctx_r137.onMouseEnter({ activeOption: option_r134, filteredOptionList: ctx_r137.optionsFiltered, index: ctx_r137.optionsFiltered.indexOf(option_r134) }); })("click", function NgxSelectComponent_ul_6_li_2_a_3_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r138); const option_r134 = ctx.$implicit; const ctx_r139 = ɵngcc0.ɵɵnextContext(3); return ctx_r139.optionSelect(option_r134, $event); });
    ɵngcc0.ɵɵelementContainer(2, 20);
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const option_r134 = ctx.$implicit;
    const idxOption_r135 = ctx.index;
    const idxGroup_r129 = ɵngcc0.ɵɵnextContext().index;
    const ctx_r132 = ɵngcc0.ɵɵnextContext(2);
    const _r102 = ɵngcc0.ɵɵreference(8);
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction2(3, _c6, option_r134.active, option_r134.disabled));
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r132.templateOption || _r102)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction4(6, _c7, option_r134, option_r134.highlightedText, idxGroup_r129, idxOption_r135));
} }
...
function NgxSelectComponent_ul_6_li_2_Template(rf, ctx) { if (rf & 1) {
    ...
    const opt_r128 = ctx.$implicit;
    const idxGroup_r129 = ctx.index;
    const ctx_r126 = ɵngcc0.ɵɵnextContext(2);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", opt_r128.type === "optgroup" && idxGroup_r129 > 0);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", opt_r128.type === "optgroup");
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngForOf", opt_r128.optionsFiltered || ɵngcc0.ɵɵpureFunction1(4, _c8, opt_r128))("ngForTrackBy", ctx_r126.trackByOption);
} }
...
function NgxSelectComponent_ul_6_li_3_Template(rf, ctx) { if (rf & 1) {
    ...
    const _r104 = ɵngcc0.ɵɵreference(10);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r127.templateOptionNotFound || _r104)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction1(2, _c9, ctx_r127.inputText));
} }
function NgxSelectComponent_ul_6_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵclassProp("show", ctx_r101.showChoiceMenu());
    ɵngcc0.ɵɵproperty("ngClass", ctx_r101.dropDownMenuOtherClasses);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵproperty("ngForOf", ctx_r101.optionsFiltered)("ngForTrackBy", ctx_r101.trackByOption);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !ctx_r101.optionsFiltered.length);
} }
function NgxSelectComponent_ng_template_7_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "span", 18);
} if (rf & 2) {
    const text_r141 = ctx.text;
    ɵngcc0.ɵɵproperty("innerHtml", text_r141, ɵngcc0.ɵɵsanitizeHtml);
} }
function NgxSelectComponent_ng_template_9_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵtext(0);
} if (rf & 2) {
    const ctx_r105 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵtextInterpolate1(" ", ctx_r105.noResultsFound, " ");
} }
